                            ...
                            <div class="portfolioContainer">
                                <div class="col-sm-6 col-lg-3 col-md-4 webdesign illustrator">
                                    <div class="gal-detail thumb">
                                        <a href="admin_periksa">
                                            <img src="assets/images/gallery/periksa.png" class="thumb-img" alt="work-thumbnail">
                                        </a>
                                        <h4><center>Laporan Periksa</center></h4>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-lg-3 col-md-4 graphicdesign illustrator photography">
                                    <div class="gal-detail thumb">
                                        <a href="admin_resep">
                                            <img src="assets/images/gallery/resep.png" class="thumb-img" alt="work-thumbnail">
                                        </a>
                                        <h4><center>Laporan Resep</center></h4>
                                    </div>
                                </div>

                                <div class="col-sm-6 col-lg-3 col-md-4 webdesign graphicdesign">
                                    <div class="gal-detail thumb">
                                        <a href="admin_transaksi">
                                            <img src="assets/images/gallery/transaksi.png" class="thumb-img" alt="work-thumbnail">
                                        </a>
                                        <h4><center>Laporan Tranksaksi</center></h4>
                                    </div>
                                </div>
